package com.zhelearn.CSUSTPlanet.feature.mooc.viewmodel
...
import com.zhelearn.CSUSTPlanet.feature.mooc.data.MoocDataHelper
import com.zhelearn.CSUSTPlanet.feature.mooc.data.local.MoocLocalCache
import com.zhelearn.CSUSTPlanet.feature.mooc.data.model.MoocUiState
import com.zhelearn.CSUSTPlanet.utils.ResourceUtil
...
class MoocViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun extractPendingHomeworks(state: MoocUiState = _uiState.value): List<com.zhelearn.CSUSTPlanet.overview.ui.model.OverviewHomeworkUiModel> {
        val courses = (state.courses as? ApiResponse.Success)?.data.orEmpty()
        return MoocDataHelper.extractPendingHomeworks(courses)
    }

    fun extractPendingTests(state: MoocUiState = _uiState.value): List<com.zhelearn.CSUSTPlanet.overview.ui.model.OverviewTestUiModel> {
        val courses = (state.courses as? ApiResponse.Success)?.data.orEmpty()
