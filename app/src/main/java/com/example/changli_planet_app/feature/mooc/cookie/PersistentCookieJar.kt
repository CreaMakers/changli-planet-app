...
class PersistentCookieJar : CookieJar {
    ...
    override fun saveFromResponse(url: HttpUrl, cookies: List<Cookie>) {
        ...
        val list = memoryCache.getOrPut(host){
            ...
            if (json != null){
                ...
                Log.d(TAG, "saveFromResponse: Loaded ${cookies.size} cookies from MMKV for host: $host")
                cookies
            }
            else{
    ...
    fun clear() {
        ...
        pendingTasks.clear()
        Log.d(TAG, "clear: Cleared pending tasks, memory cache size before clear: ${memoryCache.size}")
        memoryCache.clear()
        mmkv.clearAll()
