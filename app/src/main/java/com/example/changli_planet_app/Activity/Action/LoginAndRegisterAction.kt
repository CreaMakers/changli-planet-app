...
sealed class LoginAndRegisterAction {
    ...
    data class Login(val userPassword: UserPassword,val context: Context):LoginAndRegisterAction()
    data class Register(val userPassword: UserPassword,val context: Context):LoginAndRegisterAction()
}